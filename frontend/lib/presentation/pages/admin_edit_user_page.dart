...
class _AdminEditUserPageState extends State<AdminEditUserPage> {
  ...
  void initState() {
    ...
    _isBlacklisted =
        ...
        widget.user['status'] == 'blacklisted';
    ...
    try {
      ...
      if (kendaraans != null && kendaraans.isNotEmpty) {
        ...
        setState(() {
          ...
          _selectedJenisKendaraan =
              jenis[0].toUpperCase() + jenis.substring(1).toLowerCase();
          if (_selectedJenisKendaraan != 'Motor' &&
              _selectedJenisKendaraan != 'Mobil') {
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          style: TextStyle(
            fontSize: 14,
            color: readOnly ? _kMuted : Colors.black,
          ),
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(8),
              borderSide: BorderSide(color: readOnly ? _kBorder : _kBlue),
            ),
          ),
        ),
      ],
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 16),
                      _buildDropdown('User Category', _selectedRole, _kRoles, (
                        v,
                      ) {
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.bold,
                                  color: _isBlacklisted ? _kRed : _kText,
                                ),
                              ),
                              ...
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 11,
                                    fontWeight: FontWeight.w600,
                                    color: _isBlacklisted ? _kRed : _kGreen,
                                  ),
                                ),
                              ),
                            ],
                          ...
                          Text(
                            _isBlacklisted
                                ? 'Akses parkir pengguna ini sedang diblokir.'
                                : 'Pengguna dapat menggunakan fasilitas parkir.',
                            style: TextStyle(
                              fontSize: 12,
                              color: _isBlacklisted
